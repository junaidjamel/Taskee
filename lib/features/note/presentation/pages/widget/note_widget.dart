      ...
      builder: (context, state) {
        ...
        if (state is NoteLoadedState) {
          ...
          return CardSwiper(
            ...
            isLoop: true,
            numberOfCardsDisplayed: notes.length.clamp(
              1,
              3,
  ...
  Widget _lightCard(BuildContext context) {
    return Container(
      ...
      child: _CardContent(
        ...
        tagBg: Colors.black.withOpacity(0.12),
        tagText: _kTextDark.withOpacity(0.7),
        iconColor: _kTextDark.withOpacity(0.5),
        onDelete: onDelete,
      ),
    );
  }

  // ── Glassmorphism card (behind cards) ───────────────────────────────────
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: _CardContent(
            ...
            tagBg: Colors.white.withOpacity(0.12),
            tagText: _kTextLight.withOpacity(0.7),
            iconColor: _kTextLight.withOpacity(0.5),
            onDelete: onDelete,
          ),
        ),
      ),
